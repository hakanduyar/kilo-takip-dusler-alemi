...
export const WeeklyPlanStats = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <Card className="bg-white/90 backdrop-blur-sm border border-green-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        <CardContent className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm text-green-700 font-bold">Haftalık Ortalama</p>
              <p className="text-xl font-black text-green-800">{weeklyAverage.toFixed(1)} kg</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-white/90 backdrop-blur-sm border border-indigo-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        <CardContent className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm text-indigo-700 font-bold">Kalan Süre</p>
              <p className="text-xl font-black text-indigo-800">{remainingWeeks} hafta</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-white/90 backdrop-blur-sm border border-purple-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        <CardContent className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm text-purple-700 font-bold">İlerleme</p>
              <p className="text-xl font-black text-purple-800">%{Math.round(progress)}</p>
            </div>
          </div>
        </CardContent>
      </Card>
