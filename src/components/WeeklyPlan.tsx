        ...
        <TabsContent value="input">
          ...
          <div className="mt-6 flex justify-end">
            <Button 
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold px-6 py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200"
            >
              İlerlemeyi Kaydet
            </Button>
          </div>
